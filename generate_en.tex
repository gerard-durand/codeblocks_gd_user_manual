...
\file{C:\osp Projects\osp wxWidgets-3.2.1}. Next unzip the patch into the same directory letting it overwrite files. Note that we are going to refer to the wx root directory from now on as \var{wxDir}
...
You can simply modify the line containing (line 1659 in wxWidgets 3.2.1):
\begin{verbatim}
