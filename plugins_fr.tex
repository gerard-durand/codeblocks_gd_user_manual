...
\input{autoversioning_fr}
\end{AUTOVERSIONING}

\begin{BROWSETRACKS}
\input{browsetracks_fr}
\end{BROWSETRACKS}

\begin{CODESNIPPETS}
\input{codesnippets_fr}
\end{CODESNIPPETS}

\begin{CODECOMPLETION}
\input{codecompletion_fr}
\end{CODECOMPLETION}
...
\input{incremental_search_fr}
\end{INCREMENTALSEARCH}

\begin{NASSISHNEIDERMAN}
\input{nassishneiderman_fr}
...
\begin{SPELLCHECKER}
\input{spellchecker_fr}
\end{SPELLCHECKER}

\begin{SRCEXPORTER}
\input{src_exporter_fr}
\end{SRCEXPORTER}
...
\begin{THREADSEARCH}
\input{thread_search_fr}
\end{THREADSEARCH}

\begin{MOREPLUGINS}
\input{more_plugins_fr}
\end{MOREPLUGINS}
