...
\textbf{/v}     & \footnotesize{\opt{--verbose}}                & Active la journalisation des erreurs de c::b.                 \\ \hline
                & \footnotesize{\opt{-S setName}}               & Configure "setName" en tant qu'ensemble courant de
                                                                  variables globales (après [r13245])                           \\ \hline
                & \footnotesize{\opt{-D $<$set$>$.uservar.mem=val}} & Configure le membre mem de la variable utilisateur
