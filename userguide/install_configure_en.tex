...
\end{itemize}
\hint{Don't use zip.exe version provided by Msys2 (installed via pacman -S zip) to generate \codeblocks: it has apparently problems with standard backslashs used in Windows paths.}
