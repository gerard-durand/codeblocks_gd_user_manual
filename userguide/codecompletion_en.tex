...
%        \endhead   % To repeat the title line, if needed
        mingw-w64-clang-x86\_64-clang-tools-extra   & clang64\osp bin\osp clangd.exe        \\
        mingw-w64-x86\_64-clang-tools-extra         & mingw64\osp bin\osp clangd.exe        \\
        mingw-w64-ucrt-x86\_64-clang-tools-extra    & ucrt64\osp bin\osp clangd.exe         \\ \hline
    ...
    \subparagraph*{MSYS2 Compiler - MinGW32} \hspace{0pt} \\
     ...
     \item The first option in order to  minimise disk space is to install the Clang extra tools using one of the following packages:
        ...
        \textbf{Package}                            & \textbf{Clangd executable}    \\ \hline
%        \endhead   % To repeat the title line, if needed
        mingw-w64-clang-i686-clang-tools-extra      & clang32\osp bin\osp clangd.exe        \\
        mingw-w64-i686-clang-tools-extra            & mingw32\osp bin\osp clangd.exe        \\ \hline
