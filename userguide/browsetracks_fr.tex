\section{Browse Tracker (Suivi de Navigation)}\label{sec:browsetracker}
...
Le menu \menu{Affichage,Suivi de Navigation,Tout Effacer} permet d'effacer l'historique.

Dans les différents \samp{onglets} vous pouvez naviguer entre les divers éléments des fichiers récemment ouverts en utilisant l'entrée de menu \menu{Affichage,Suivi de Navigation,Aller en arrière/Aller en avant} ou en utilisant les raccourcis claviers \textbf{Alt-Gauche/Alt-Droit}. Le menu de suivi de navigation est également accessible dans les menus de contexte. Les marqueurs sont enregistrés dans un fichier de mise en page \file{\var{projectName}.bmarks}
